...
type VendorCreateLabeledOrderDraftRequest struct {
	state         protoimpl.MessageState                       `protogen:"open.v1"`
	Data          []*VendorCreateLabeledOrderDraftRequest_Data `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *VendorCreateLabeledOrderDraftRequest) Reset() {
	*x = VendorCreateLabeledOrderDraftRequest{}
	mi := &file_api_order_v1_api_vendor_order_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VendorCreateLabeledOrderDraftRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VendorCreateLabeledOrderDraftRequest) ProtoMessage() {}

func (x *VendorCreateLabeledOrderDraftRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_order_v1_api_vendor_order_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VendorCreateLabeledOrderDraftRequest.ProtoReflect.Descriptor instead.
func (*VendorCreateLabeledOrderDraftRequest) Descriptor() ([]byte, []int) {
	return file_api_order_v1_api_vendor_order_proto_rawDescGZIP(), []int{4}
}

func (x *VendorCreateLabeledOrderDraftRequest) GetData() []*VendorCreateLabeledOrderDraftRequest_Data {
	if x != nil {
		return x.Data
	}
	return nil
...
type VendorCreateLabeledOrderDraftResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        string                 `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
	Result        []*VendorOrderDraft    `protobuf:"bytes,3,rep,name=result,proto3" json:"result,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *VendorCreateLabeledOrderDraftResponse) Reset() {
	*x = VendorCreateLabeledOrderDraftResponse{}
	mi := &file_api_order_v1_api_vendor_order_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VendorCreateLabeledOrderDraftResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VendorCreateLabeledOrderDraftResponse) ProtoMessage() {}

func (x *VendorCreateLabeledOrderDraftResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_order_v1_api_vendor_order_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VendorCreateLabeledOrderDraftResponse.ProtoReflect.Descriptor instead.
func (*VendorCreateLabeledOrderDraftResponse) Descriptor() ([]byte, []int) {
	return file_api_order_v1_api_vendor_order_proto_rawDescGZIP(), []int{5}
}

func (x *VendorCreateLabeledOrderDraftResponse) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *VendorCreateLabeledOrderDraftResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *VendorCreateLabeledOrderDraftResponse) GetResult() []*VendorOrderDraft {
	if x != nil {
		return x.Result
	}
	return nil
...
type LegacyVendorGetPriceQuoteResponse struct {
	state         protoimpl.MessageState                              `protogen:"open.v1"`
	Data          *LegacyVendorGetPriceQuoteResponse_PriceCalculation `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type VendorCreateLabeledOrderDraftRequest_Data struct {
	state               protoimpl.MessageState    `protogen:"open.v1"`
	ReferenceId         string                    `protobuf:"bytes,1,opt,name=reference_id,json=referenceId,proto3" json:"reference_id,omitempty"`
	ShippingServiceType VendorShippingServiceType `protobuf:"varint,2,opt,name=shipping_service_type,json=shippingServiceType,proto3,enum=api.order.v1.VendorShippingServiceType" json:"shipping_service_type,omitempty"`
...
func (x *VendorCreateLabeledOrderDraftRequest_Data) Reset() {
	*x = VendorCreateLabeledOrderDraftRequest_Data{}
	mi := &file_api_order_v1_api_vendor_order_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VendorCreateLabeledOrderDraftRequest_Data) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VendorCreateLabeledOrderDraftRequest_Data) ProtoMessage() {}

func (x *VendorCreateLabeledOrderDraftRequest_Data) ProtoReflect() protoreflect.Message {
	mi := &file_api_order_v1_api_vendor_order_proto_msgTypes[10]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VendorCreateLabeledOrderDraftRequest_Data.ProtoReflect.Descriptor instead.
func (*VendorCreateLabeledOrderDraftRequest_Data) Descriptor() ([]byte, []int) {
	return file_api_order_v1_api_vendor_order_proto_rawDescGZIP(), []int{4, 0}
}

func (x *VendorCreateLabeledOrderDraftRequest_Data) GetReferenceId() string {
	if x != nil {
...
func (x *VendorCreateLabeledOrderDraftRequest_Data) GetShippingServiceType() VendorShippingServiceType {
	if x != nil {
		return x.ShippingServiceType
	}
	return VendorShippingServiceType_VENDOR_SHIPPING_SERVICE_TYPE_UNSPECIFIED
}

func (x *VendorCreateLabeledOrderDraftRequest_Data) GetStoreId() string {
	if x != nil {
		return x.StoreId
	}
	return ""
...
func (x *VendorCreateLabeledOrderDraftRequest_Data) GetAgreeAtRisk() bool {
	if x != nil {
...
func (x *VendorCreateLabeledOrderDraftRequest_Data) GetShippingLabelLinks() []string {
	if x != nil {
...
func (x *VendorCreateLabeledOrderDraftRequest_Data) GetGiftMessageBody() string {
	if x != nil {
...
func (*LegacyVendorGetPriceQuoteRequest_LineItem) Descriptor() ([]byte, []int) {
	return file_api_order_v1_api_vendor_order_proto_rawDescGZIP(), []int{8, 0}
}
...
func (*LegacyVendorGetPriceQuoteResponse_PriceCalculation) Descriptor() ([]byte, []int) {
	return file_api_order_v1_api_vendor_order_proto_rawDescGZIP(), []int{9, 0}
}
...
var file_api_order_v1_api_vendor_order_proto_rawDesc = string([]byte{
	...
	,
	...
	,
	...
	0x69, 0x6e, 0x67, 0x12, 0x32, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x02, 0x20, 0x03, 0x28,
	...
	0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x91, 0x01, 0x0a, 0x16, 0x56, 0x65, 0x6e, 0x64,
	...
	0x31, 0x2e, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x46, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x52, 0x0e, 0x40, 0x73, 0x71, 0x75, 0x61, 0x73, 0x68, 0x2e, 0x66, 0x69, 0x6c,
	0x74, 0x65, 0x72, 0x12, 0x36, 0x0a, 0x06, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x74, 0x79, 0x70,
	0x65, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x52, 0x0e, 0x40, 0x73, 0x71,
	0x75, 0x61, 0x73, 0x68, 0x2e, 0x70, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x22, 0x80, 0x01, 0x0a, 0x17,
	...
	,
	...
	0x6e, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x42, 0x08, 0xba,
	0x48, 0x05, 0x82, 0x01, 0x02, 0x10, 0x01, 0x52, 0x13, 0x73, 0x68, 0x69, 0x70, 0x70, 0x69, 0x6e,
	0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x24, 0x0a, 0x08,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42, 0x09,
	0xba, 0x48, 0x06, 0x72, 0x04, 0x10, 0x01, 0x18, 0x64, 0x52, 0x07, 0x73, 0x74, 0x6f, 0x72, 0x65,
	...
	0x61, 0x62, 0x65, 0x6c, 0x4c, 0x69, 0x6e, 0x6b, 0x73, 0x12, 0x34, 0x0a, 0x11, 0x67, 0x69, 0x66,
	...
	,
	...
	0x69, 0x6e, 0x6b, 0x42, 0x61, 0x63, 0x6b, 0x22, 0x82, 0x03, 0x0a, 0x21, 0x4c, 0x65, 0x67, 0x61,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x40, 0x2e, 0x61, 0x70,
	...
	,
	...
	,
	...
	0x16, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x10, 0x12, 0x0e, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x33,
	0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x12, 0x8b, 0x01, 0x0a, 0x14, 0x56, 0x65, 0x6e, 0x64,
	...
	,
	...
	0x74, 0x2f, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x65, 0x64, 0x12, 0x8b, 0x01, 0x0a, 0x13, 0x56, 0x65,
	0x6e, 0x64, 0x6f, 0x72, 0x47, 0x65, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x51, 0x75, 0x6f, 0x74,
	0x65, 0x12, 0x28, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x76, 0x31,
	...
	0x73, 0x2f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x32, 0xba, 0x01, 0x0a, 0x14, 0x4c, 0x65, 0x67, 0x61,
	0x63, 0x79, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x41, 0x50, 0x49,
	0x12, 0xa1, 0x01, 0x0a, 0x19, 0x4c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x56, 0x65, 0x6e, 0x64, 0x6f,
	0x72, 0x47, 0x65, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x12, 0x2e,
	...
	0x63, 0x65, 0x51, 0x75, 0x6f, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2f,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x2e, 0x4c, 0x65,
	0x67, 0x61, 0x63, 0x79, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x47, 0x65, 0x74, 0x50, 0x72, 0x69,
	...
	0x2f, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x2f, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x73, 0x2f, 0x70,
	0x72, 0x69, 0x63, 0x65, 0x42, 0xb6, 0x01, 0x0a, 0x10, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69,
...
var file_api_order_v1_api_vendor_order_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_api_order_v1_api_vendor_order_proto_goTypes = []any{
	...
	(*VendorCreateLabeledOrderDraftRequest)(nil),               // 4: api.order.v1.VendorCreateLabeledOrderDraftRequest
	(*VendorCreateLabeledOrderDraftResponse)(nil),              // 5: api.order.v1.VendorCreateLabeledOrderDraftResponse
	(*VendorGetPriceQuoteRequest)(nil),                         // 6: api.order.v1.VendorGetPriceQuoteRequest
	(*VendorGetPriceQuoteResponse)(nil),                        // 7: api.order.v1.VendorGetPriceQuoteResponse
	(*LegacyVendorGetPriceQuoteRequest)(nil),                   // 8: api.order.v1.LegacyVendorGetPriceQuoteRequest
	(*LegacyVendorGetPriceQuoteResponse)(nil),                  // 9: api.order.v1.LegacyVendorGetPriceQuoteResponse
	(*VendorCreateLabeledOrderDraftRequest_Data)(nil),          // 10: api.order.v1.VendorCreateLabeledOrderDraftRequest.Data
	(*LegacyVendorGetPriceQuoteRequest_LineItem)(nil),          // 11: api.order.v1.LegacyVendorGetPriceQuoteRequest.LineItem
	(*LegacyVendorGetPriceQuoteResponse_PriceCalculation)(nil), // 12: api.order.v1.LegacyVendorGetPriceQuoteResponse.PriceCalculation
	(*VendorOrderDraftFilter)(nil),                             // 13: api.order.v1.VendorOrderDraftFilter
	(*v1.Paging)(nil),                                          // 14: common.type.v1.Paging
	(*v1.PagingResponse)(nil),                                  // 15: common.type.v1.PagingResponse
	(*VendorOrderDraft)(nil),                                   // 16: api.order.v1.VendorOrderDraft
	(*VendorOrderFilter)(nil),                                  // 17: api.order.v1.VendorOrderFilter
	(*VendorOrder)(nil),                                        // 18: api.order.v1.VendorOrder
	(*VendorOrderPriceCalculation_Billing)(nil),                // 19: api.order.v1.VendorOrderPriceCalculation.Billing
	(*VendorOrderPriceCalculation_Shipping)(nil),               // 20: api.order.v1.VendorOrderPriceCalculation.Shipping
	(*VendorOrderPriceCalculation_LineItem)(nil),               // 21: api.order.v1.VendorOrderPriceCalculation.LineItem
	(*VendorOrderPriceCalculation_GiftMessage)(nil),            // 22: api.order.v1.VendorOrderPriceCalculation.GiftMessage
	(*VendorOrderPriceCalculation_OrderPriceQuote)(nil),        // 23: api.order.v1.VendorOrderPriceCalculation.OrderPriceQuote
	(*v1.LegacyCredentials)(nil),                               // 24: common.type.v1.LegacyCredentials
	(VendorShippingServiceType)(0),                             // 25: api.order.v1.VendorShippingServiceType
}
var file_api_order_v1_api_vendor_order_proto_depIdxs = []int32{
	13, // 0: api.order.v1.VendorListOrderDraftRequest.filter:type_name -> api.order.v1.VendorOrderDraftFilter
	14, // 1: api.order.v1.VendorListOrderDraftRequest.paging:type_name -> common.type.v1.Paging
	15, // 2: api.order.v1.VendorListOrderDraftResponse.paging:type_name -> common.type.v1.PagingResponse
	16, // 3: api.order.v1.VendorListOrderDraftResponse.data:type_name -> api.order.v1.VendorOrderDraft
	17, // 4: api.order.v1.VendorListOrderRequest.filter:type_name -> api.order.v1.VendorOrderFilter
	14, // 5: api.order.v1.VendorListOrderRequest.paging:type_name -> common.type.v1.Paging
	15, // 6: api.order.v1.VendorListOrderResponse.paging:type_name -> common.type.v1.PagingResponse
	18, // 7: api.order.v1.VendorListOrderResponse.data:type_name -> api.order.v1.VendorOrder
	10, // 8: api.order.v1.VendorCreateLabeledOrderDraftRequest.data:type_name -> api.order.v1.VendorCreateLabeledOrderDraftRequest.Data
	16, // 9: api.order.v1.VendorCreateLabeledOrderDraftResponse.result:type_name -> api.order.v1.VendorOrderDraft
	19, // 10: api.order.v1.VendorGetPriceQuoteRequest.billing:type_name -> api.order.v1.VendorOrderPriceCalculation.Billing
	20, // 11: api.order.v1.VendorGetPriceQuoteRequest.shipping:type_name -> api.order.v1.VendorOrderPriceCalculation.Shipping
	21, // 12: api.order.v1.VendorGetPriceQuoteRequest.line_items:type_name -> api.order.v1.VendorOrderPriceCalculation.LineItem
	22, // 13: api.order.v1.VendorGetPriceQuoteRequest.gift_messages:type_name -> api.order.v1.VendorOrderPriceCalculation.GiftMessage
	23, // 14: api.order.v1.VendorGetPriceQuoteResponse.data:type_name -> api.order.v1.VendorOrderPriceCalculation.OrderPriceQuote
	24, // 15: api.order.v1.LegacyVendorGetPriceQuoteRequest.credentials:type_name -> common.type.v1.LegacyCredentials
	11, // 16: api.order.v1.LegacyVendorGetPriceQuoteRequest.line_items:type_name -> api.order.v1.LegacyVendorGetPriceQuoteRequest.LineItem
	12, // 17: api.order.v1.LegacyVendorGetPriceQuoteResponse.data:type_name -> api.order.v1.LegacyVendorGetPriceQuoteResponse.PriceCalculation
	25, // 18: api.order.v1.VendorCreateLabeledOrderDraftRequest.Data.shipping_service_type:type_name -> api.order.v1.VendorShippingServiceType
	2,  // 19: api.order.v1.VendorOrderAPI.VendorListOrder:input_type -> api.order.v1.VendorListOrderRequest
	0,  // 20: api.order.v1.VendorOrderAPI.VendorListOrderDraft:input_type -> api.order.v1.VendorListOrderDraftRequest
	4,  // 21: api.order.v1.VendorOrderAPI.VendorCreateLabeledOrderDraft:input_type -> api.order.v1.VendorCreateLabeledOrderDraftRequest
	6,  // 22: api.order.v1.VendorOrderAPI.VendorGetPriceQuote:input_type -> api.order.v1.VendorGetPriceQuoteRequest
	8,  // 23: api.order.v1.LegacyVendorOrderAPI.LegacyVendorGetPriceQuote:input_type -> api.order.v1.LegacyVendorGetPriceQuoteRequest
	3,  // 24: api.order.v1.VendorOrderAPI.VendorListOrder:output_type -> api.order.v1.VendorListOrderResponse
	1,  // 25: api.order.v1.VendorOrderAPI.VendorListOrderDraft:output_type -> api.order.v1.VendorListOrderDraftResponse
	5,  // 26: api.order.v1.VendorOrderAPI.VendorCreateLabeledOrderDraft:output_type -> api.order.v1.VendorCreateLabeledOrderDraftResponse
	7,  // 27: api.order.v1.VendorOrderAPI.VendorGetPriceQuote:output_type -> api.order.v1.VendorGetPriceQuoteResponse
	9,  // 28: api.order.v1.LegacyVendorOrderAPI.LegacyVendorGetPriceQuote:output_type -> api.order.v1.LegacyVendorGetPriceQuoteResponse
