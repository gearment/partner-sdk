...
func (x *VendorCatalogVariant) GetNetPrice() *v1.Money {
	if x != nil {
		return x.NetPrice
	}
	return nil
...
type VendorCatalogShippingFee struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Variant ID (unique identifier)
	VariantId string `protobuf:"bytes,1,opt,name=variant_id,json=variantId,proto3" json:"variant_id,omitempty"`
	// Product ID
	...
	// Color hex code (e.g., "#000000", "#FFFFFF")
	HexColorCode string `protobuf:"bytes,6,opt,name=hex_color_code,json=hexColorCode,proto3" json:"hex_color_code,omitempty"`
	// Variant SKU
	VariantSku string `protobuf:"bytes,7,opt,name=variant_sku,json=variantSku,proto3" json:"variant_sku,omitempty"`
	// Color code
	ColorCode string `protobuf:"bytes,8,opt,name=color_code,json=colorCode,proto3" json:"color_code,omitempty"`
	// Size code
	SizeCode         string                             `protobuf:"bytes,9,opt,name=size_code,json=sizeCode,proto3" json:"size_code,omitempty"`
	ShippingServices []*VendorCatalogShippingFeeService `protobuf:"bytes,10,rep,name=shipping_services,json=shippingServices,proto3" json:"shipping_services,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}

func (x *VendorCatalogShippingFee) Reset() {
	*x = VendorCatalogShippingFee{}
	mi := &file_api_catalog_v1_data_vendor_catalog_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VendorCatalogShippingFee) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VendorCatalogShippingFee) ProtoMessage() {}

func (x *VendorCatalogShippingFee) ProtoReflect() protoreflect.Message {
	mi := &file_api_catalog_v1_data_vendor_catalog_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VendorCatalogShippingFee.ProtoReflect.Descriptor instead.
func (*VendorCatalogShippingFee) Descriptor() ([]byte, []int) {
	return file_api_catalog_v1_data_vendor_catalog_proto_rawDescGZIP(), []int{2}
}

func (x *VendorCatalogShippingFee) GetVariantId() string {
	if x != nil {
		return x.VariantId
	}
	return ""
...
func (x *VendorCatalogShippingFee) GetProductId() string {
	if x != nil {
		return x.ProductId
	}
	return ""
...
func (x *VendorCatalogShippingFee) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *VendorCatalogShippingFee) GetSize() string {
	if x != nil {
		return x.Size
	}
	return ""
...
func (x *VendorCatalogShippingFee) GetColor() string {
	if x != nil {
		return x.Color
	}
	return ""
...
func (x *VendorCatalogShippingFee) GetHexColorCode() string {
	if x != nil {
		return x.HexColorCode
	}
	return ""
...
func (x *VendorCatalogShippingFee) GetVariantSku() string {
	if x != nil {
		return x.VariantSku
	}
	return ""
...
func (x *VendorCatalogShippingFee) GetColorCode() string {
	if x != nil {
		return x.ColorCode
	}
	return ""
...
func (x *VendorCatalogShippingFee) GetSizeCode() string {
	if x != nil {
		return x.SizeCode
	}
	return ""
...
func (x *VendorCatalogShippingFee) GetShippingServices() []*VendorCatalogShippingFeeService {
	if x != nil {
		return x.ShippingServices
	}
	return nil
}

type VendorCatalogShippingFeeService struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Shipping fee for the base item quantity.
	FeeAmount *v1.Money `protobuf:"bytes,1,opt,name=fee_amount,json=feeAmount,proto3" json:"fee_amount,omitempty"`
	// Shipping fee for each additional item.
	AdditionalItem *v1.Money `protobuf:"bytes,2,opt,name=additional_item,json=additionalItem,proto3" json:"additional_item,omitempty"`
	// Shipping profile identifier.
	ShippingProfile string `protobuf:"bytes,3,opt,name=shipping_profile,json=shippingProfile,proto3" json:"shipping_profile,omitempty"`
	// Shipping service display name.
...
func (x *VendorCatalogShippingFeeService) Reset() {
	*x = VendorCatalogShippingFeeService{}
	mi := &file_api_catalog_v1_data_vendor_catalog_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *VendorCatalogShippingFeeService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*VendorCatalogShippingFeeService) ProtoMessage() {}

func (x *VendorCatalogShippingFeeService) ProtoReflect() protoreflect.Message {
	mi := &file_api_catalog_v1_data_vendor_catalog_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use VendorCatalogShippingFeeService.ProtoReflect.Descriptor instead.
func (*VendorCatalogShippingFeeService) Descriptor() ([]byte, []int) {
	return file_api_catalog_v1_data_vendor_catalog_proto_rawDescGZIP(), []int{3}
}

func (x *VendorCatalogShippingFeeService) GetFeeAmount() *v1.Money {
	if x != nil {
		return x.FeeAmount
	}
	return nil
...
func (x *VendorCatalogShippingFeeService) GetAdditionalItem() *v1.Money {
	if x != nil {
		return x.AdditionalItem
	}
	return nil
}

func (x *VendorCatalogShippingFeeService) GetShippingProfile() string {
	if x != nil {
...
func (x *VendorCatalogShippingFeeService) GetShippingService() string {
	if x != nil {
...
func (x *LegacyVendorCatalog) Reset() {
	*x = LegacyVendorCatalog{}
	mi := &file_api_catalog_v1_data_vendor_catalog_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LegacyVendorCatalog) Descriptor() ([]byte, []int) {
	return file_api_catalog_v1_data_vendor_catalog_proto_rawDescGZIP(), []int{7}
}
...
func (x *LegacyVendorCatalogVariant) Reset() {
	*x = LegacyVendorCatalogVariant{}
	mi := &file_api_catalog_v1_data_vendor_catalog_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LegacyVendorCatalogVariant) Descriptor() ([]byte, []int) {
	return file_api_catalog_v1_data_vendor_catalog_proto_rawDescGZIP(), []int{8}
}
...
var file_api_catalog_v1_data_vendor_catalog_proto_rawDesc = string([]byte{
	...
	0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x49, 0x64, 0x22, 0x93, 0x05, 0x0a, 0x14, 0x56, 0x65, 0x6e,
	...
	0x79, 0x52, 0x0a, 0x65, 0x78, 0x74, 0x72, 0x61, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x32, 0x0a,
	0x09, 0x6e, 0x65, 0x74, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x15, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x76,
	0x31, 0x2e, 0x4d, 0x6f, 0x6e, 0x65, 0x79, 0x52, 0x08, 0x6e, 0x65, 0x74, 0x50, 0x72, 0x69, 0x63,
	0x65, 0x12, 0x59, 0x0a, 0x0b, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x5f, 0x6c, 0x61, 0x62, 0x65, 0x6c,
	0x18, 0x09, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2e, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x61, 0x74,
	...
	0x6b, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x42, 0x08, 0xba, 0x48, 0x05, 0x82, 0x01, 0x02, 0x10, 0x01,
	0x52, 0x0a, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x4c, 0x61, 0x62, 0x65, 0x6c, 0x12, 0x37, 0x0a, 0x07,
	0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1d, 0x2e,
	0x61, 0x70, 0x69, 0x2e, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x2e, 0x76, 0x31, 0x2e, 0x56,
	0x65, 0x6e, 0x64, 0x6f, 0x72, 0x43, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x52, 0x07, 0x70, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x12, 0x2a, 0x0a, 0x11, 0x6c, 0x65, 0x67, 0x61, 0x63, 0x79, 0x5f,
	0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x05,
	...
	0x18, 0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x53,
	0x6b, 0x75, 0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x5f, 0x63, 0x6f, 0x64, 0x65,
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x63, 0x6f, 0x6c, 0x6f, 0x72, 0x43, 0x6f, 0x64,
	0x65, 0x12, 0x1b, 0x0a, 0x09, 0x73, 0x69, 0x7a, 0x65, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x0e,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x73, 0x69, 0x7a, 0x65, 0x43, 0x6f, 0x64, 0x65, 0x22, 0xf7,
	0x02, 0x0a, 0x18, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x43, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67,
	0x53, 0x68, 0x69, 0x70, 0x70, 0x69, 0x6e, 0x67, 0x46, 0x65, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x76,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x45, 0x4c, 0x5f, 0x41, 0x4c, 0x4c, 0x10, 0x05, 0x42, 0xc7, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x63, 0x61, 0x74, 0x61, 0x6c, 0x6f, 0x67, 0x2e, 0x76, 0x31, 0x42,
	0x16, 0x44, 0x61, 0x74, 0x61, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x43, 0x61, 0x74, 0x61, 0x6c,
...
var file_api_catalog_v1_data_vendor_catalog_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_api_catalog_v1_data_vendor_catalog_proto_goTypes = []any{
	...
	(*VendorCatalogShippingFee)(nil),        // 3: api.catalog.v1.VendorCatalogShippingFee
	(*VendorCatalogShippingFeeService)(nil), // 4: api.catalog.v1.VendorCatalogShippingFeeService
	(*VendorCatalogPrintLocation)(nil),      // 5: api.catalog.v1.VendorCatalogPrintLocation
	(*VendorCatalogFilter)(nil),             // 6: api.catalog.v1.VendorCatalogFilter
	(*VendorCatalogVariantFilter)(nil),      // 7: api.catalog.v1.VendorCatalogVariantFilter
	(*LegacyVendorCatalog)(nil),             // 8: api.catalog.v1.LegacyVendorCatalog
	(*LegacyVendorCatalogVariant)(nil),      // 9: api.catalog.v1.LegacyVendorCatalogVariant
	(*v1.Money)(nil),                        // 10: common.type.v1.Money
}
var file_api_catalog_v1_data_vendor_catalog_proto_depIdxs = []int32{
	5,  // 0: api.catalog.v1.VendorCatalog.print_locations:type_name -> api.catalog.v1.VendorCatalogPrintLocation
	2,  // 1: api.catalog.v1.VendorCatalog.variants:type_name -> api.catalog.v1.VendorCatalogVariant
	10, // 2: api.catalog.v1.VendorCatalogVariant.price:type_name -> common.type.v1.Money
	10, // 3: api.catalog.v1.VendorCatalogVariant.recommended_price:type_name -> common.type.v1.Money
	10, // 4: api.catalog.v1.VendorCatalogVariant.extra_price:type_name -> common.type.v1.Money
	10, // 5: api.catalog.v1.VendorCatalogVariant.net_price:type_name -> common.type.v1.Money
	0,  // 6: api.catalog.v1.VendorCatalogVariant.stock_label:type_name -> api.catalog.v1.VendorCatalogVariantStockLabel
	1,  // 7: api.catalog.v1.VendorCatalogVariant.product:type_name -> api.catalog.v1.VendorCatalog
	4,  // 8: api.catalog.v1.VendorCatalogShippingFee.shipping_services:type_name -> api.catalog.v1.VendorCatalogShippingFeeService
	10, // 9: api.catalog.v1.VendorCatalogShippingFeeService.fee_amount:type_name -> common.type.v1.Money
	10, // 10: api.catalog.v1.VendorCatalogShippingFeeService.additional_item:type_name -> common.type.v1.Money
	0,  // 11: api.catalog.v1.VendorCatalogVariantFilter.stock_labels:type_name -> api.catalog.v1.VendorCatalogVariantStockLabel
	9,  // 12: api.catalog.v1.LegacyVendorCatalog.variants:type_name -> api.catalog.v1.LegacyVendorCatalogVariant
