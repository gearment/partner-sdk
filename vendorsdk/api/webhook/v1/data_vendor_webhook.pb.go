...
const (
	...
	VendorWebhook_TOPIC_ALL                         VendorWebhook_Topic = 1 // All topics (used for filtering)
	VendorWebhook_TOPIC_ORDER_COMPLETED             VendorWebhook_Topic = 2 // Order completed and shipped
	VendorWebhook_TOPIC_ORDER_CANCELLED             VendorWebhook_Topic = 3 // Order canceled
	VendorWebhook_TOPIC_TRACKING_ORDER_UPDATED      VendorWebhook_Topic = 4 // Tracking information updated
	VendorWebhook_TOPIC_ORDER_ON_HOLD               VendorWebhook_Topic = 5 // Order placed on hold
	VendorWebhook_TOPIC_SHIPPING_ADDRESS_VERIFIED   VendorWebhook_Topic = 6 // Shipping address verified
	VendorWebhook_TOPIC_SHIPPING_ADDRESS_UNVERIFIED VendorWebhook_Topic = 7 // Shipping address unverified
	VendorWebhook_TOPIC_PRODUCT_OUT_OF_STOCK        VendorWebhook_Topic = 8 // Product out of stock
)
...
const (
	...
	VendorWebhook_VERSION_ALL     VendorWebhook_Version = 1 // All versions (used for filtering)
	VendorWebhook_VERSION_V1      VendorWebhook_Version = 2 // Webhook payload version 1 (legacy)
	VendorWebhook_VERSION_V3      VendorWebhook_Version = 3 // Webhook payload version 3 (current)
)
...
const (
	...
	VendorWebhook_STATUS_ALL      VendorWebhook_Status = 1 // All statuses (used for filtering)
	VendorWebhook_STATUS_ACTIVE   VendorWebhook_Status = 2 // Webhook is active and will receive events
	VendorWebhook_STATUS_INACTIVE VendorWebhook_Status = 3 // Webhook is inactive and will not receive events
)
...
type VendorWebhook struct {
	...
	// Event topic this webhook subscribes to
	...
	// URL where webhook events will be delivered (HTTPS required)
...
func (x *VendorWebhook) GetTeamId() string {
	if x != nil {
		return x.TeamId
	}
	return ""
...
func (x *VendorWebhook) GetStoreId() string {
	if x != nil {
		return x.StoreId
	}
	return ""
...
var file_api_webhook_v1_data_vendor_webhook_proto_rawDesc = string([]byte{
	...
	0x72, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfa, 0x0c, 0x0a, 0x0d, 0x56, 0x65, 0x6e,
	...
	,
	...
	,
	...
	0x49, 0x56, 0x45, 0x10, 0x03, 0x42, 0xc7, 0x01, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x77, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x2e, 0x76, 0x31, 0x42, 0x16, 0x44, 0x61,
	0x74, 0x61, 0x56, 0x65, 0x6e, 0x64, 0x6f, 0x72, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x50,
	...
	0x70, 0x69, 0x2f, 0x77, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x2f, 0x76, 0x31, 0x3b, 0x77, 0x65,
	0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x76, 0x31, 0xa2, 0x02, 0x03, 0x41, 0x57, 0x58, 0xaa, 0x02, 0x0e,
	0x41, 0x70, 0x69, 0x2e, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x2e, 0x56, 0x31, 0xca, 0x02,
	0x0e, 0x41, 0x70, 0x69, 0x5c, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x5c, 0x56, 0x31, 0xe2,
	0x02, 0x1a, 0x41, 0x70, 0x69, 0x5c, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x5c, 0x56, 0x31,
	0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x10, 0x41,
	0x70, 0x69, 0x3a, 0x3a, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x3a, 0x3a, 0x56, 0x31, 0x62,
